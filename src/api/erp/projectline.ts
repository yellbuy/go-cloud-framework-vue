...
export default {
    ...
    getListByScope: async (params: object = {}) => {
        const url = `/v1/admin/erp/projectline`;
    ...
    getById: async (id: number | string) => {
        const url = `/v1/admin/erp/projectline/${id}`;
    ...
    save: async (data: object) => {
        ...
        const url = `/v1/admin/erp/projectline/${data.Id}`;
        return await http.post(url, data);
    },
    ...
    delete: async (id: number | string) => {
        const url = `/v1/admin/erp/projectline/delete/${id}`;
