...
export default {
    ...
    getListByScope: async (kind: string, scopeMode: number = 0, scopeValue: number = 0, params: object = {}) => {
        const url = `/psi/v1/admin/subject/${kind}/${scopeMode}/${scopeValue}`;
    ...
    getList: async (params: object = {}) => {
        const url = `/psi/v1/admin/subject`;
        return await http.get(url, params);
    },
    ...
    getById: async (id: number | string) => {
        const url = `/psi/v1/admin/subject/${id}`;
    ...
    save: async (data: object) => {
        ...
        const url = `/psi/v1/admin/subject/${data.Id}`;
        return await http.post(url, data);
    },
    ...
    delete: async (id: number | string) => {
        const url = `/psi/v1/admin/subject/delete/${id}`;
