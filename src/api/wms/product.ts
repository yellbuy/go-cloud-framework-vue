...
export default {
    ...
    getListByScope: async (kind: string, scopeMode: number = 0, scopeValue: number = 0, params: object = {}) => {
        const url = `/v1/admin/wms/product/${kind}/${scopeMode}/${scopeValue}`;
    ...
    getList: async (params: object = {}) => {
        const url = `/v1/admin/wms/product`;
        return await http.get(url, params);
    },
    /**
     * 获取信息
    ...
    getById: async (id: number | string) => {
        const url = `/v1/admin/wms/product/${id}`;
    ...
    save: async (data: object) => {
        ...
        const url = `/v1/admin/wms/product/${data.Id}`;
        return await http.post(url, data);
    },
    ...
    delete: async (id: number | string) => {
        const url = `/v1/admin/wms/product/delete/${id}`;
   ...
   */
    disable: async (data: object) => {
        const url = `/v1/admin/wms/product/disable`;
        return await http.post(url, data);
    },
    /**
    * 获取项目专家信息
    ...
    */
    expertList: async (id: number | string) => {
        const url = `/v1/admin/wms/product/expertlist/${id}`;
        return await http.get(url);
    },
    /**
    * 项目专家信息
    ...
    */
    expertSave: async (data: object) => {
        const url = `/v1/admin/wms/product/expert`;
        return await http.post(url, data);
    },
     /**
    * 监审专家授权
    ...
    */
    empowerSave: async (data: object) => {
        const url = `/v1/admin/wms/product/empower`;
        return await http.post(url, data);
    },
      /**
    * 获取公司报名信息
    ...
    */
    signUpDetail: async (id: number | string,companyId: number | string) => {
        const url = `/v1/admin/wms/product/signup/${id}/${companyId}`;
        return await http.get(url);
    },
}