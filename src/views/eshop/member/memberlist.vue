	...
	<div class="ims-case-firstaudit-container">
		<el-card shadow="hover">
			<div class="">
				<el-form ref="searchFormRef" :model="tableData.param" label-width="80px" :inline="true">
					<el-form-item :label="'状态：'">
						<el-select v-model="tableData.param.enable" placeholder="请选择" style="width: 90px">
			...
			>
				...
				<el-table-column prop="Avatar" label="头像" align="center" width="70" fixed>
					<template #default="scope">
						<el-image
							...
							:src="proxy.$utils.staticHeardUrl(scope.row.Id)"
							hide-on-click-modal
							:preview-src-list="[proxy.$utils.staticHeardUrl(scope.row.Id)]"
							:initial-index="0"
							fit="cover"
						>
							<template #error>
				...
				<el-table-column prop="Point" label="H币" width="80" align="right" show-overflow-tooltip fixed></el-table-column>
				<el-table-column prop="Enable" label="状态" width="80" align="center" show-overflow-tooltip>
					<template #default="scope">
						<el-tag type="warning" effect="plain" v-if="scope.row.Enable == 0">停用</el-tag>
						<el-tag type="success" effect="plain" v-else-if="scope.row.Enable == 1">可用</el-tag>
				...
				<el-table-column prop="Idno" label="身份证" width="115" align="left" show-overflow-tooltip> </el-table-column>
				<el-table-column prop="Mobile" label="手机号" width="115" align="left" show-overflow-tooltip> </el-table-column>
				...
				<el-table-column prop="Username" label="登录名" width="240" align="left" show-overflow-tooltip> </el-table-column>
...
export default {
	...
	setup() {
		...
		//重置查询条件
		const onResetSearch = () => {
			state.tableData.param.enable = -1;
