		...
		<el-card shadow="hover">
			<div class="">
				<el-form ref="searchFormRef" :model="tableData.param" label-width="80px" :inline="true">
					...
					<el-form-item v-if="kind != 'virtual'" :label="'类型：'">
					...
					<el-form-item v-if="kind != 'virtual'" :label="'销核状态：'">
			...
			>
				...
				<el-table-column v-if="kind != 'virtual'" prop="ExtTag" label="类型" width="70" show-overflow-tooltip fixed></el-table-column>
				...
				<el-table-column v-if="kind != 'virtual'" prop="ShippingState" label="销核状态" width="80" align="center" show-overflow-tooltip>
					<template #default="scope">
				...
				<el-table-column v-if="kind != 'virtual'" prop="ConfirmBy" label="销核人" width="80" align="left" show-overflow-tooltip> </el-table-column>
				<el-table-column
					v-if="kind != 'virtual'"
					prop="ConfirmTime"
					label="销核时间"
				...
				<el-table-column v-if="kind != 'virtual'" prop="OrderAmount" label="订单金额" width="80" align="center" show-overflow-tooltip>
					<template #default="scope">
