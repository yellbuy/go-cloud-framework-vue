      ...
      <div id="data-view">
        <dv-full-screen-container v-if="isFullScreen">
            <div id="top-header">
              ...
              <div class="center-title">认知障碍友好社区信息智慧管理系统 </div>
              <div style="position:absolute;top:10px;right:10px">
                <dv-button @click="onFullScreen" border="Border3" color="#c8161d" font-color="#e18a3b" style="margin:10px">{{isFullScreen?'退出全屏':'全屏'}}</dv-button>
              </div>
            </div>
