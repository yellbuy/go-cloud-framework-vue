  ...
  <div>
    <div id="data-view">
      <!-- <dv-full-screen-container> -->
        <top-header />
        <dv-border-box-12 style="width:98%;padding:6px;margin:1%">
          ...
          <div class="flex-row">
              ...
              <dv-digital-flop
                  :config="{number:[1000],content: '{nt} 人',style:{fill: '#f46827',fontWeight: 'bold',fontSize:16}}"
              ...
              <dv-digital-flop
                  :config="{number:[20],content: '{nt} 人',style:{fill: '#e3dc0f',fontWeight: 'bold',fontSize:16}}"
                  style="width: 100%; height: 24px"
              />
              </div>
              <div class="digital-flop-item">
                  ...
                  <dv-digital-flop
                      :config="{number:[50],content: '{nt} 人',style:{fill: 'lightgreen',fontWeight: 'bold',fontSize:16}}"
                      style="width: 100%; height: 24px"
                  />
              </div>
              <div class="digital-flop-item">
                  ...
                  <div>
                      <dv-digital-flop
                      :config="{number:[100],content: '{nt} 次',style:{fill: 'lightgreen',fontWeight: 'bold',fontSize:16}}"
                      style="width: 100%; height: 24px"/>
                  </div>
      ...
      <div class="main-rows">
          <dv-border-box-13 style="width:29%;padding:12px;margin:1%;text-align:center;">
              <h1 style="margin-top:10px">年龄段分析</h1>
              <dv-active-ring-chart :config="{lineWidth: 30, data: [{ name: '< 65岁',value: 55},{name: '65-80岁',value: 120},{name: '> 80岁',value: 78}]}" style="width:300px;height:300px;"/>
          </dv-border-box-13>
          <dv-border-box-13 :reverse="true" style="width:69%;padding:12px;margin:1%;text-align:center;">
              <h1 style="margin-top:10px">风险等级分析</h1>
              <scroll-board />
          </dv-border-box-13>
      </div>
      <div class="main-rows">
          <dv-border-box-13 style="width:29%;padding:12px;margin:1%;text-align:center;">
              <h1 style="margin-top:10px">风险人群后续跟进方式</h1>
              <dv-active-ring-chart :config="{lineWidth: 30, data: [{ name: '< 65岁',value: 55},{name: '65-80岁',value: 120},{name: '> 80岁',value: 78}]}" style="width:300px;height:300px;"/>
          </dv-border-box-13>
          <dv-border-box-13 :reverse="true" style="width:69%;padding:12px;margin:1%;text-align:center;">
              <h1 style="margin-top:10px">干预课程体验感</h1>
              <scroll-board />
          </dv-border-box-13>
      </div>
    </div>
