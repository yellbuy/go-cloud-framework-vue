   ...
   setup() {
    ...
    const setData=()=>{
      if(state.timeMode=="day") {
            state.option.xAxis.data=state.energyData.day.Name||[]
            state.option.series[0].data=state.energyData.day.Amount||[]
            state.option.series[1].data=state.energyData.day.Volume||[]
        }
        else if(state.timeMode=="month") {
            state.option.xAxis.data=state.energyData.month.Name||[]
            state.option.series[0].data=state.energyData.month.Amount||[]
            state.option.series[1].data=state.energyData.month.Volume||[]
        }
        else if(state.timeMode=="year") {
            state.option.xAxis.data=state.energyData.year.Name||[]
            state.option.series[0].data=state.energyData.year.Amount||[]
            state.option.series[1].data=state.energyData.year.Volume||[]
        }
    }
