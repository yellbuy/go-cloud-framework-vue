<template>
	<div>
	  ...
	  <DxStateStoring
          :enabled="true"
          type="localStorage"
          storageKey="dashboard-chart-tradebuninessbill_v1.1"
        />
...
const createDataSource:any = ()=>{
	...
	const dataSource = new PivotGridDataSource({
		...
		fields: [{
			caption: '产品',
			width: 120,
			dataField: 'ParentGoodsName',
			area: 'row',
			sortBySummaryField: 'Total',
		}, {
			caption: '规格',
			dataField: 'ParentGoodsSkuName',
			width: 150,
			area: 'filter',
		},{
			caption: "类别",
			dataField: "ParentGoodsCategoryName",
			expanded: true,
			area: "filter"
		},{
			caption: "供应商",
			dataField: "ParentCustomerName",
			expanded: true,
			area: "filter"
		},{
			caption: "公司",
