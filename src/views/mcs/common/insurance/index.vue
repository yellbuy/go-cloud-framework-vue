	...
	<div class="base-role-container">
		<el-card shadow="hover">
			...
			<el-table
				...
				<el-table-column prop="CompulsoryStartDate" label="交强险起始日" width="100" align="center" :formatter="dateFormatYMD"  show-overflow-tooltip />
				<el-table-column prop="CompulsoryEndDate" label="交强险到期日" width="100" align="center" :formatter="dateFormatYMD"  show-overflow-tooltip />
				<el-table-column prop="CompulsoryFee" label="交强险费用(元)" width="100" align="right" show-overflow-tooltip />
				<el-table-column prop="CommercialStartDate" label="商业险起始日" width="100" align="center" :formatter="dateFormatYMD"  show-overflow-tooltip />
				<el-table-column prop="CommercialEndDate" label="商业险到期日" width="100" align="center" :formatter="dateFormatYMD"  show-overflow-tooltip />
				<el-table-column prop="CommercialFee" label="商业险费用(元)" width="100" align="right" show-overflow-tooltip />
				<el-table-column prop="TaxFee" label="车船税费用(元)" width="100" align="right" show-overflow-tooltip />
				<el-table-column prop="CompanyName" label="所属公司" align="left" show-overflow-tooltip />
				<el-table-column prop="CreateTime" label="创建时间" width="100" align="center" :formatter="dateFormatYMD" show-overflow-tooltip />
