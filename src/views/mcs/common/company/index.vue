	...
	<div class="base-role-container">
		<el-card shadow="hover">
			...
			>
				...
				<el-table-column prop="CompanyAlias" label="客户简称" show-overflow-tooltip width="100"></el-table-column>
				<el-table-column prop="Idno" label="证件号码" show-overflow-tooltip width="130"></el-table-column>
				<el-table-column prop="CreateTime" label="公司注册时间" width="115" :formatter="dateFormatYMDHM" show-overflow-tooltip></el-table-column>
				<el-table-column prop="Linkman" label="联系人" show-overflow-tooltip width="80"></el-table-column>
				<el-table-column prop="Tel" label="电话" show-overflow-tooltip width="100"></el-table-column>
