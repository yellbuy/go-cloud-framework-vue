<template>
    <div class="system-edit-user-container">
        <el-dialog :title="title" v-model="isShowDialog" width="80%" :before-close="closeDialog">
            <el-divider content-position="left">派工</el-divider>
            <div class="">
                <el-form>
                    <el-form-item>
            ...
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="130px" label-suffix="：" v-loading="loading">
				<el-row :gutter="20">
					<el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8" class="mb20">
						<el-form-item label="维修工" prop="GoodsName">
							<el-input v-model="ruleForm.GoodsName" placeholder="请输入维修工姓名"></el-input> 
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8" class="mb20">
						<el-form-item label="工时" prop="GoodsSn">
							<el-input v-model="ruleForm.Qty" placeholder="请输入商品编号"></el-input> 
						</el-form-item>
					</el-col>					
				</el-row>
			</el-form>
