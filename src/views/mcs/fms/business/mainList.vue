	...
	<div class="base-business-main-container">
		<el-card shadow="hover">
			...
			>
				...
				<el-table-column prop="BillNo" label="流水单号" width="120" sortable show-overflow-tooltip="true" fixed></el-table-column>
				<el-table-column prop="GoodsName" label="产品名称" width="120" sortable show-overflow-tooltip="true" fixed></el-table-column>
				<el-table-column prop="CustomerName" label="客户名称" width="180" sortable show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="SenderAddress" label="发货站" width="200" sortable show-overflow-tooltip="true"></el-table-column>				
				<el-table-column prop="ReceiverAddress" label="到达地" width="200"  sortable show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="Weight" label="吨位" width="80" align="right"  sortable show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="PlanVehicleCount" label="列数" width="80" align="right"  sortable show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="BillTime" label="日期" width="80" align="left" sortable :formatter="dateFormatYMD" show-overflow-tooltip="true"></el-table-column>		
				...
				<el-table-column prop="CompanyName" label="所属公司" sortable show-overflow-tooltip="true"></el-table-column>
