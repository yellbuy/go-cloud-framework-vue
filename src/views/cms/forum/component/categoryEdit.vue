		...
		<el-dialog :title="title" v-model="isShowDialog" width="80%">
				...
				<el-row :gutter="10">
					<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
						...
						<el-form-item label="父级" prop="Parentid">
							<el-tree-select v-model="ruleForm.Parentid" placeholder="请选择父级" default-expand-all node-key="Id"
						...
						<el-form-item label="描述" prop="Description">
							<el-input v-model="ruleForm.Description" placeholder="描述" maxlength="255" clearable 
			...
			<template #footer>
				<span class="dialog-footer">
					...
					<el-button type="primary" @click="onSubmit(false)" v-if="!ruleForm.Id"  :loading="loading" v-auth:[$parent.moduleKey]="'btn.CategoryAdd'">{{ $t('message.action.saveAndAdd') }}</el-button>
					<el-button type="primary" @click="onSubmit(true)"  :loading="loading" v-auths:[$parent.moduleKey]="['btn.CategoryEdit','btn.CategoryAdd']">{{ $t('message.action.save') }}</el-button>
