		...
		<el-dialog :title="title" v-model="isShowDialog" width="90%">
				...
				<el-row :gutter="10">
					<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
						...
						<el-form-item label="发布时间" prop="PublishTime">
							<el-date-picker v-model="ruleForm.PublishTime" type="datetime" format="YYYY-MM-DD HH:mm:ss" placeholder="选择发布时间" />
						</el-form-item>
						...
						<el-card class="box-card">
							...
							<div>
								...
								<el-form-item prop="ViewNum" label="虚拟阅读量">
									<el-input type="number" v-model="ruleForm.ViewNum" placeholder="虚拟阅读量" maxlength="10" :min="0" :max="1000000000" :step="100">
										<template #prepend>
			...
			<template #footer>
				<span class="dialog-footer">
					...
					<el-button type="primary" @click="onSubmit(false)" v-if="!ruleForm.Id" :loading="loading" v-auth:[$parent.moduleKey]="'btn.ArticleAdd'">{{
						$t('message.action.saveAndAdd')
					}}</el-button>
					<el-button type="primary" @click="onSubmit(true)" :loading="loading" v-auths:[$parent.moduleKey]="['btn.ArticleEdit', 'btn.ArticleAdd']">{{
