<template>
	<div class="system-edit-user-container">
		<el-dialog v-model="isShowDialog" destroy-on-close title="获取信息" width="80%">
			<el-table :data="tableData.data" style="width: 100%" v-loading="tableData.loading" :height="proxy.$calcMainHeight(-170)" border stripe highlight-current-row @select="select" @select-all="selectAll">
