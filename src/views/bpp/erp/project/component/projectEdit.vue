    ...
    >
      ...
      >
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8" class="mb10">
            <el-form-item prop="RemoteState">
              <el-checkbox v-model="ruleForm.RemoteState" :true-label="1" :false-label="0"
                >视频会议</el-checkbox
              >
            </el-form-item>
          </el-col>
        ...
        <el-form size="small" label-width="90px" :inline="true">
          <el-form-item>
            <el-button
              size="small"
              type="primary"
              @click="onOpenItemDialog('zgps', true,{})"
            >
              <el-icon>
                <CirclePlusFilled />
              </el-icon>
        ...
        <el-form size="small" label-width="90px" :inline="true">
          <el-form-item>
            <el-button
              size="small"
              type="primary"
              @click="onOpenItemDialog('jsps', true,{})"
            >
              <el-icon>
                <Plus />
              </el-icon>
        ...
        <el-form ref="jjFormRef" :model="jjForm" size="small" v-loading="loading">
          <el-row :gutter="20">
            ...
            <el-col
              ...
              class="mb10"
              :offset="1"
              v-if="jjForm.ScoreMode == 0"
            >
              <div class="mb10">
                评审价格从低至高排列（最低价为第一名），第一名供应商价格得分为满分；
              </div>
              <div class="mb10">
                从第二名起，价格得分减少<span
                  ><el-input-number
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" :offset="1" class="mb10">
              <div class="mb10">
                本项目技术评审最高分：{{
                  jjForm.TechnicalScore
                }}分，最终评审价格最高分：{{ jjForm.TechnicalMaxScore }} 分。
              </div>
        ...
        <el-row :gutter="20" v-if="ruleForm.ProjectType == 1">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb10 ml30">
            <h3>
              注意：如果此公开比选项目不足三家供应商参与，是否自动转为竞争性谈判项目？
            </h3>
          </el-col>
          <el-form-item prop="AutoSwitchState">
            <el-checkbox
              v-model="ruleForm.AutoSwitchState"
              :true-label="1"
              :false-label="0"
              >不足三家供应商，转竞争性谈判</el-checkbox
            >
          </el-form-item>
        </el-row>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
          <el-button text bg @click="onCancel">{{
...
export default {
  ...
  setup() {
    ...
    const onRemove = (file: UploadFile) => {
      console.log(file);
      let removeUrl = file.url.substring(
        file.url.indexOf("/static/upload/image/"),
        file.url.length
      );
