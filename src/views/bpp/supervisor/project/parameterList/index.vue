	...
	<el-card>
		...
		<el-tabs v-model="activeName" type="card" class="demo-tabs" @tab-change="tabsName">
			<el-tab-pane label="资格评审" name="zgps">
				<el-form :model="zgTableData.param" label-width="60px" :inline="true" style="margin-bottom: 10px;">
					<el-form-item>
						<el-button type="primary" @click="onGetZgTableData(true)">创建</el-button>
						<el-button text bg type="info" @click="onOpenCommondata(0)">恢复默认</el-button>
					</el-form-item>
				</el-form>
			...
			<el-tab-pane label="技术评审" name="jsps">
				<el-form :model="jsTableData.param" label-width="60px" :inline="true" style="margin-bottom: 10px;">
					<el-form-item>
						<el-button type="primary" @click="onGetJsTableData(true)">创建</el-button>
						<el-button text bg type="info" @click="onOpenCommondata(0)">恢复默认</el-button>
					</el-form-item>
				</el-form>
