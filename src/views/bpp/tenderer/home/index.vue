	...
	<div class="home-container">
					...
					<div class="ml24 flex quote-block tip pt12">
						...
						<div class="ml20 p5">
							<div class="mt12">
								...
								<div class="home-card-first-right-msg mt6">供应商</div>
							</div>
						</div>
					</div>
		...
		<el-row :gutter="15" class="mb15">
			<el-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16" class="home-warning-media">
				...
				<el-card shadow="hover" class="home-warning-card mt10">
					<template #header>
						<div class="card-header">
							<el-row :gutter="15">
								<el-col :sm="12">
				...
				<el-card shadow="hover" header="快速开始 / 便捷导航">
					<div class="home-dynamic">
						<el-scrollbar>
							...
							<el-row :gutter="15">
								<el-col :sm="8">
									<el-link type="primary">基本信息</el-link>
								</el-col>
								<el-col :sm="8">
									<el-link type="primary">项目报名</el-link>
								</el-col>
								<el-col :sm="8">
									<el-link type="primary">项目比选</el-link>
								</el-col>
							</el-row>
