		...
		<div v-if="isSelection">
			<el-card shadow="hover">
				<div class="">
					<el-form ref="searchFormRef" :model="tableData.param" label-width="60px" :inline="true">
						<el-form-item label="比选编号">
							<el-input placeholder="请输入比选编号查询" v-model="tableData.param.no"/>
						</el-form-item>
						<el-form-item label="比选项目">
							<el-input placeholder="请输入比选项目查询" v-model="tableData.param.name"/>
						</el-form-item>
						<el-form-item>
				...
				<el-table :data="tableData.data" v-loading="tableData.loading" style="width: 100%" :height="proxy.$calcMainHeight(-75)" border stripe highlight-current-row>
					...
					<el-table-column prop="No" label="比选编号" show-overflow-tooltip fixed/>
					...
					<el-table-column prop="Name" label="比选项目" show-overflow-tooltip/>
					<el-table-column prop="fanwei" label="比选范围" show-overflow-tooltip/>
					<el-table-column prop="EndTime" label="报名截止日期" :formatter="dateFormatYMDHM" show-overflow-tooltip/>
					<el-table-column prop="ReviewTime" label="评选日期" :formatter="dateFormatYMDHM" show-overflow-tooltip/>
