<template>
  <div class="visualizing-demo2">
    ...
    <div class="big-data-up">
      <div class="up-left">
        <SvgIcon class="mr5" name="ele-Timer"/>
        <span>{{ time.txt }}</span>
      </div>
      <div class="up-center">
        <span>智慧农业系统平台</span>
      ...
      <div class="up-right">
        <el-dropdown size="small">
					<span class="el-dropdown-link">
						{{ dropdownActive }}
						<SvgIcon class="el-icon--right" name="ele-ArrowDown"/>
					</span>
          <template #dropdown>
            <el-dropdown-menu>
        ...
        <div class="ml15">
          <SvgIcon class="mr5" name="ele-Bell"/>
          <span>消息</span>
        </div>
        <div class="ml15">
          <SvgIcon class="mr5" name="ele-User"/>
          <span>个人</span>
        </div>
        <div class="ml15">
          <SvgIcon class="mr5" name="ele-SwitchButton"/>
          <span>返回</span>
        </div>
      </div>
    </div>
    ...
    <div class="big-data-down">
      ...
      <div class="big-data-down-left">
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div class="flex-content flex-content-overflow">
              <div class="sky">
                <SvgIcon class="sky-left" name="ele-Sunny"/>
              ...
              <div class="sky-dd">
                <div v-for="(v, k) in skyList" :key="k" :class="{ 'sky-dl-first': k === 1 }" class="sky-dl">
                  <div>{{ v.v1 }}</div>
            ...
            <div class="flex-content flex-content-overflow">
              <div class="d-states">
                <div class="d-states-item">
                  <SvgIcon class="i-bg1" name="ele-Odometer"/>
                ...
                <div class="d-states-item">
                  <SvgIcon class="i-bg2" name="ele-FirstAidKit"/>
                  <div class="d-states-flex">
                ...
                <div class="d-states-item">
                  <SvgIcon class="i-bg3" name="ele-VideoPlay"/>
                  <div class="d-states-flex">
              ...
              <div class="d-btn">
                <div v-for="(v, k) in dBtnList" :key="k" :class="{ 'd-btn-active': dBtnActive === k }"
                     class="d-btn-item">
                  <SvgIcon class="d-btn-item-left" name="ele-Money"/>
        ...
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData1" class="flex-content"></div>
          </div>
        </div>
      </div>
      ...
      <div class="big-data-down-center">
        <div class="big-data-down-center-one">
          <div ref="rightChartData5" class="big-data-down-center-one-content">
            <div id="3DEarth"></div>
            <div v-for="(v, k) in earth3DBtnList" :key="k" :class="v.topLevelClass">
              <div v-for="i in 4" :key="i" class="circle"></div>
              <div class="text-box">
                <SvgIcon :name="v.icon"/>
          ...
          <div class="flex-warp-item-box">
            ...
            <div class="flex-content">
              <div class="flex-content-left">
                <div v-for="(v, k) in chartData4List" :key="k" class="monitor-item">
                  <div :class="{ 'monitor-active': k === chartData4Index }" class="monitor-wave">
              ...
              <div ref="rightChartData4" class="flex-content-right"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="big-data-down-right">
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData3" class="flex-content"></div>
          </div>
        </div>
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
        ...
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData2" class="flex-content"></div>
          </div>
        </div>
      </div>
    </div>
...
import {chartData4List, dBtnList, dropdownList, earth3DBtnList, skyList} from './mock/demo2';
