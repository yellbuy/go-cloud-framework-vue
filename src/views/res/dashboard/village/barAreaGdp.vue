  ...
  <div id="flareTarget">
    <dv-border-box10>
      <div class="flare-container">
        <div class="flare-title" style="text-align: left;padding-left:10px">村人均可支配收入对比</div>
  ...
  setup() {
    ...
    onMounted(async () => {
        const data = [
          ...
          { name: '大龙潭村', 年份: '2022', 城镇: 0, 农村:0 },
          { name: '大龙潭村', 年份: '2023', 城镇: 51292, 农村:30301 },
          { name: '大龙潭村', 年份: '2024', 城镇: 54063, 农村:32696 },
        ];
