    ...
    <dv-full-screen-container>
      <div id="banner">
        <div class="banner-content">
          <dv-button style="display:inline-block;margin-left:10px;" fontSize="12" @click="onGoToLink(`/admin/index`)" border="Border4" color="#409EFF">区建成</dv-button>
          <dv-button style="display:inline-block;margin-left:10px;" fontSize="12" @click="onGoToLink(`/admin/dashboard/street/index?areaCode=${areaCode}&areaName=${areaName}`)" border="Border4" color="#409EFF">乡进入</dv-button>
