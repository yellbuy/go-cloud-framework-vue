...
export default defineComponent({
	...
	setup(props) {
		...
		const onElMenuHorizontalScroll = (e: any) => {
			...
			const scrollLeft=proxy.$refs.elMenuHorizontalScrollRef.$refs.wrapRef.scrollLeft + eventDelta / 4;
			proxy.$refs.elMenuHorizontalScrollRef.$refs.wrapRef.scrollLeft = scrollLeft;
		};
